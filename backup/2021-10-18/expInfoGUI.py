...
def showGUI(condition,spatialization,trialNum=96,blockNum=2,scr=1):
    ...
    infoDlg = gui.DlgFromDict(dictionary=info, 
        ...
        order=['Condition','Spatialization','Subject','Trial Number','Block Number','Screen Index','PsychoPy Version'],
